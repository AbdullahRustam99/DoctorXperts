...
export default function LoginPage() {
  return (
    <>
      ...
      className=" py-16 px-5 lg:px-32 text-primary">
          ...
          <div className="">
            ...
            <div className=" mx-2 lg:mx-20 flex-1 flex flex-col max-w-md space-y-8 ">
              ...
              <div className=" space-y-2">
                <h1 className="text-2xl lg:text-4xl font-extrabold tracking-tight">Get Start Now</h1>
              ...
              <form className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="user-name" type="text" placeholder="jon23" />
                  </div>
                  <div className="space-y-2">
